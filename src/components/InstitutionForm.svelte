<script>
    import InstitutionTag from './InstitutionTag.svelte';
    ...
    const handleSubmit = () => {
        ...
        const institution = {
            id: "institution" + Date.now() + "x" + Math.random(),
            type: "institution",
            website,
        ...
        dispatch('addInstitutionNode', institution)
    }
    };
    ...
    const validateSubmission = () => {
        ...
        if (stateName == "" || cityName == undefined)
        {
            valid = false;
            errorMessage += "\n-City"
        }
...
<div class = "inside">
<h1 class = "formType">New Non-Academic Insitution</h1>
<h2>1. Enter Information</h2>
<p><span class = "red">*</span>Required fields</p>
<form>
    <p>Name<span class = "red">*</span></p>
    <input type = "text" placeholder = "Insitution Name" bind:value = {instName} required>
