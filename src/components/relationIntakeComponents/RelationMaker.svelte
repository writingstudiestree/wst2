...
<div class="d-inline-flex flex-wrap p-2 align-items-center">
	...
	<div class = "rightSpace"><input type="number" class = "form-control numberWidth" bind:value={value.year_start}>
	</div>
	<div class = "rightSpace">-</div>
	<div class = "rightSpace"><input type="number" class = "form-control numberWidth" bind:value={endYear} disabled={ongoing}>
	</div>
